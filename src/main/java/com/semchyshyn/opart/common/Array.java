...
public abstract class Array {
	public static <Class> int find(final Class @NonNull[] array,
	...
	public static <Class> void rotate(final Class @NonNull[] array,
	                                  int distance) {
	...
	public static <Class> void reverse(final Class @NonNull[] array,
	                                   int start, int end) {
		while (start < end) {

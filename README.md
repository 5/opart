...
## Workflow
 ...
 5. ### Imagine
	...
	public class Piece extends OpArt {
		protected final @NonNull Value<Double> radius = new Value<>(Range.UNIT, Change.DECELERATING, Type.DOUBLE);
 ...
 7. ### Publish
	Publish the new piece of optical art by manually uploading it to such major social media platforms as
	  * [YouTube](https://www.youtube.com/upload),
	  * [TikTok](https://www.tiktok.com/tiktokstudio/upload),
	  * [Instagram](https://about.instagram.com/features/reels), and
	  * [X](https://help.x.com/en/using-x/x-videos)

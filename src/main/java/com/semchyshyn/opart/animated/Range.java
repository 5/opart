...
public class Range implements Interval<Double> {
	public static final @NonNull Range ZERO_POINT    = new Range( 0d, 0d);
	...
	public static final @NonNull Range HALF_CIRCLE   = new Range( 0d, Math.PI);
	public static final @NonNull Range FULL_CIRCLE   = new Range( 0d, Math.TAU);
